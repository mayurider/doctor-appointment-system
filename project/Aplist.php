			...
			<ul>
				...
				<li>
					<a href="#">VIEW ></a>
						...
						<h5>_______________</h5><br>
						<li class="active"><a href="Aplist.php"> PATIENT </a></li>
						<h5>_______________</h5><br>
			...
			<div class="dlist">
				...
				<table border="2" class="tbladj" bordercolor="grey">
					...
					<?php 
						...
						echo "<tr><td>".$row[0]."</td><td>".$row[1]."</td><td>".$row[2]."</td><td>".$row[3]."</td><td>".$row[4]."</td><td>".$row[5]."</td><td>".$row[6]."</td><td><a href='Pdelete.php'><img src='delete.png' height='20' width='60'></a></td>";
						echo "</table";
					?>
				</table>
				</div>
